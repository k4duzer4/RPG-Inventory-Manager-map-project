            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        System.out.println("1. " + player1.getName());
                        System.out.println("2. " + player2.getName());
                        int fromChoice = Integer.parseInt(scanner.nextLine());
                        ...
                        if (itemToTrade != null) {
                            ...
                            mediator.exchangeItem(fromPlayer, toPlayer, itemName, quantity);
                        } else {
                    ...
                    case 5:
                        ...
                        System.out.println("1. " + player1.getName());
                        System.out.println("2. " + player2.getName());
                        int useChoice = Integer.parseInt(scanner.nextLine());
